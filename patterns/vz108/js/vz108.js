...
$('seg-add')?.addEventListener('click', ()=>{ addExtraSegment('segments-extra', state.extraSegments, 'EX'); pushUndoSnapshot(true); });
$('seg-remove')?.addEventListener('click', ()=>{ removeExtraSegment(state.extraSegments); pushUndoSnapshot(true); });
$('segH-add')?.addEventListener('click', ()=>{ addExtraSegment('segmentsH-extra', state.extraSegmentsH, 'EX'); pushUndoSnapshot(true); });
$('segH-remove')?.addEventListener('click', ()=>{ removeExtraSegment(state.extraSegmentsH); pushUndoSnapshot(true); });
